  ...
  return (
    <>
      <motion.div
        ...
        className={cn(
          "absolute left-0 top-20 m-auto w-[3px] rounded-full bg-gradient-to-t from-blue-500 via-purple-500 to-transparent",
